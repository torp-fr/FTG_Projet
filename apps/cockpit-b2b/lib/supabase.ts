 ...
 * build si ce module est importé dans un composant client). Le service key est lu depuis
 * l'env serveur (SUPABASE_SERVICE_ROLE_KEY, jamais préfixé NEXT_PUBLIC_) et n'est donc
...
/** Organisation démo (une seule org en v1, pas d'auth — outil interne). */
export const DEMO_ORG_NAME = "Incubateur Démo — CCI Test";
