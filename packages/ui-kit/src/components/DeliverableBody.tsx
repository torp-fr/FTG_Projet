import type { DeliverableInput } from "../types";

/**
 * Rendu lisible du structured_data d'un livrable :
 *  - match_report    → composite V3 + scores par dimension + gap map.
 *  - selection_brief → idée retenue + top-3 + journal d'entonnoir.
 *  - sinon           → contentMd si présent.
 * Source UNIQUE (JC-09) — auparavant dupliquée porteur/admin (+ inline cockpit).
 */
...
export function DeliverableBody({ deliverable }: { deliverable: DeliverableInput }) {
